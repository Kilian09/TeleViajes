...
<nav class="navbar navbar-dark navbar-expand-md text-white bg-dark navigation-clean-button"
    ...
    <div class="container">
        <a class="navbar-brand" href="/"><img src="assets/img/logo%20(1).png"
                                              style="height: 75px;background: url(&quot;https://cdn.bootstrapstudio.io/placeholders/1400x800.png&quot;);width: 200px;"></a>
        ...
        <div class="collapse navbar-collapse" id="navcol-1" style="color: #f2f5f8;">
            <ul class="nav navbar-nav mr-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="actividades" style="color: var(--light);">Actividades</a>
                </li>
                <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" data-toggle="dropdown"
                                                 aria-expanded="false" href="grupos" style="color: var(--light);">Grupos&nbsp;</a>
            ...
            <span class="d-inline navbar-text actions">
                    ...
                    <?php if (session()->has("user") == true) { ?>
                        ...
                        <a class="btn btn-light d-inline action-button" id="rojo" role="button"
                           href="usuario"><?php echo strtoupper(session("username")) ?></a>
            ...
            <?php if (session("username") == "admin") { ?>
                            <a class="btn btn-light d-inline action-button" role="button" href="shopAdmin"><e
                                    class="fa fa-cog"> </a>
                        <?php } ?>
            ...
            <article class="container" style="margin-top: 1em; text-align: center">
                <div class="dropdown-container">
                    <button class="btn btn-primary dropdown-toggle btn-sm ml-1" data-toggle="dropdown" type="button"
                            aria-expanded="true">
                        <span class="badge badge-pill badge-light"><?php echo session('cantidadTotal') ?></span>
                        <i class="fa fa-shopping-cart mx-2"></i><?php echo session('total') ?>€<span
                            class="caret"></span>
                    </button>
