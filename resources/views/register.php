        ...
        <div class="col-md-8 offset-md-2">
            <form method="post" class="custom-form" action="procesar_registro">
                ...
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="nameUser-input-field">Nombre de Usuario*</label></div>
                    <div class="col-sm-6 input-column"><input class="form-control" type="text" name="nombreDeUsuario" required></div>
                </div>
                ...
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="surname-input-field">Apellidos*</label></div>
                    <div class="col-sm-6 input-column"><input class="form-control" type="text" name="apellidos" required></div>
                </div>
                <div class="form-row form-group">
