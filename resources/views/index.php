            ...
            <div class="row justify-content-center features">
                ...
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fa fa-leaf icon"></i>
                        ...
                        <p>En nuestra oferta destacan nuestras actividades en la naturaleza y los destinos idílicos.</p><a class="learn-more" href="actividades">Ver Actividades »</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fa fa-clock-o icon"></i>
                        <h3 class="name">Durante todo el año</h3>
                        <p>Desde Enero hasta Diciembre, desde la playa hasta la nieve, de Canarias al mundo.</p><a class="learn-more" href="#carousel">Ver Oferta »</a>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fa fa-plane icon"></i>
                        ...
                        <p>Los viajes más baratos con las menores y más rápidas conexiones posibles.</p><a class="learn-more" href="#novedadesIndex">Ver Oferta »</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
