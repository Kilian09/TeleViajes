...
<section>
    <div id="w_shop_105"
         class="carousel slide w_shop_105_indicators w_shop_105_control_button thumb_scroll_x swipe_x ps_easeOutInCubic"
         data-ride="carousel" data-pause="hover" data-interval="8000" data-duration="2000">
                            ...
                            <div class="carousel-inner" role="listbox" style="margin-top: 2em">
                                <div class="carousel-item active">
                                    ...
                                    <div class="w_shop_105_left_box"><span data-animation="animated fadeInLeft"
                                        ...
                                        <h1 class="left-h"
                                            data-animation="animated fadeInLeft"><?php echo $cruise->name ?></h1>
                                        ...
                                        <form method="get" action="/addCart/<?php echo $product->id ?>">
                                            ...
                                            <button type="submit" href="#" data-animation="animated fadeInLeft">
                                                Comprar
                                            </button>
                                        </form>
                                    ...
                                    <div class="w_shop_105_right_box" data-animation="animated fadeInRight">
                                        <ul>
                                            <li data-animation="animated fadeInRight">
                                                Fechas: <?php echo $cruise->date ?></li>
                                            <li data-animation="animated fadeInRight">
                                                Precio: <?php echo $cruise->price ?>€ por persona
                                            </li>
                                            <li data-animation="animated fadeInRight">
                                                Disponibilidad: <?php echo $cruise->stock ?> plazas
                                            </li>
                                        </ul>
                                    </div>
                                </div>
