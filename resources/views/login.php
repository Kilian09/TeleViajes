...
?>
    ...
    <div class="login-dark" style="background: url(&quot;assets/img/bledd.jpg&quot;) center / cover;">
        <form method="post">
            ...
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit">IniciAR sesion</button></div><a class="forgot" href="register.html">No te has registrado aún?</a>
        </form>
    </div>
