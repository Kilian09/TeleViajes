    ...
    <div class="bg-secondary">
        <div class="container-fluid text-light bg-dark">
            ...
            <form id="contactForm" action="javascript:void(0);" method="get">
                <input class="form-control" type="hidden" name="Introduction" value="This email was sent from www.Televiajes.com">
                <input class="form-control" type="hidden" name="subject" value="Televiajes.com Contact Form">
                <input class="form-control" type="hidden" name="to" value="email@Televiajes.com">
                <div class="form-row">
                    <div class="col-md-6">
