                    ...
                    <div class="col-12 col-md-6" id="message" style="border-color: var(--blue);">
                        ...
                        <div class="form-group"><label for="from-name">Nombre</label>
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="text-body input-group-text"><i class="fa fa-user-o"></i></span></div>
                                <input class="form-control" type="text" id="from-name" name="nombre" required="" placeholder="Nombre completo">
                            </div>
                        </div>
                        <div class="form-group"><label for="from-email">Email</label>
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" id="from-email" name="email" required="" placeholder="Dirección email">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-12 col-sm-6 col-md-12 col-lg-6">
                                <div class="form-group"><label for="from-phone">Móvil</label>
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" id="from-phone" name="telefono" required="" placeholder="Nº Telefono">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group"><label for="from-comments">Comentario</label>
                            <textarea class="form-control" id="from-comments" name="comentario" placeholder="Enter Comments" rows="5"></textarea>
                        </div>
