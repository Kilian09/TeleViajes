            ...
            <form id="contactForm" action="javascript:void(0);" method="get" name="procesar_contacto">
                ...
                <div class="form-row">
                    <div class="col-12 col-md-6" id="message" style="border-color: var(--blue);">
                        <h2 class="h4"><i class="fa fa-envelope"></i> Contáctenos<small></small></h2>

                        <div class="form-group"><label for="from-name">Nombre</label>
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="text-body input-group-text"><i class="fa fa-user-o"></i></span></div><input class="form-control" type="text" id="from-name" name="nombre" required="" placeholder="Nombre completo">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-12 col-sm-6 col-md-12 col-lg-6">
                                <div class="form-group"><label for="from-phone">Movil</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-phone"></i></span></div><input class="form-control" type="text" id="from-phone" name="telefono" required="" placeholder="Nº Telefono">
                                    </div>
                                </div>
                            </div>
                        </div>

                        <div class="form-group"><label for="from-comments">Comentario</label><textarea class="form-control" id="from-comments" name="comments" placeholder="Introduzca su comentario" rows="5"></textarea></div>

                        <div class="form-group">

                            <div class="form-row">
                                <div class="col"><button class="btn btn-primary btn-block" type="reset" style="background: rgb(3,47,112);"><i class="fa fa-undo"></i>&nbsp; Borrar</button></div>
