    ...
    <div class="card-group">
        <div class="card"><img class="card-img-top w-100 d-block" src="assets/img/aurora4.jpg"
            ...
            <div class="card-body">
                ...
                <p class="text-center bg-info card-text" style="color: rgb(21,21,21);">Por <?php echo $paquete->price ?>
                    €</p>
    ...
    <div class="card-group">
        <div class="card"><img class="card-img-top w-100 d-block" src="assets/img/disney.jpg"
            ...
            <div class="card-body">
                ...
                <p class="text-center bg-info card-text" style="color: rgb(21,21,21);"><?php echo $paquete->price ?>
                    €</p>
                <form method="get" action="/addCart/<?php echo $product->id ?>">
                    <input type="number" name="amount" value="1" min="1">
                    <br>
