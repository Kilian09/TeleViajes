...
<div>
    ...
    <div id="box-3">
        <h1 style="background: url(&quot;assets/img/Parques-atracciones-Portugal-.jpg&quot;);background-size: cover;">
            LAS MEJORES EXPERIENCIAS</h1>
    </div>
    <div id="box-1">
    ...
    <div class="carousel slide" data-ride="carousel" data-interval="10000" id="carousel-t">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <div class="col-9 offset-xl-1 text-center mx-auto testimonial-content"><img class="rounded-circle"
                                                                                            src="assets/img/test-woman.jpg"
                                                                                            width="100">
